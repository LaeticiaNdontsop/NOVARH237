...
urlpatterns = [
    ...
    path("recrutements/historique/", views.HistoriqueRecrutementsView.as_view(), name="historique_recrutements"),
    ...
    path("evaluations-formations/historique/", views.HistoriqueEvaluationsFormationsView.as_view(), name="historique_evaluations_formations"),
